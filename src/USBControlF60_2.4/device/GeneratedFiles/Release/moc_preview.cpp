...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CameraPreview_t, stringdata) + ofs \
...
const QMetaObject CameraPreview::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CameraPreview.data,
      qt_meta_data_CameraPreview,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CameraPreview.stringdata))
