...
public:
    ...
    void setupUi(QMainWindow *QtDemoClass)
    {
        ...
        label_9->setGeometry(QRect(360, 520, 86, 25));
        label_10 = new QLabel(tab_control_dev);
        label_10->setObjectName(QStringLiteral("label_10"));
        label_10->setGeometry(QRect(360, 590, 86, 25));
        le_cam_height_ = new QLineEdit(tab_control_dev);
        le_cam_height_->setObjectName(QStringLiteral("le_cam_height_"));
        le_cam_height_->setGeometry(QRect(360, 620, 113, 31));
        label_14 = new QLabel(tab_control_dev);
        label_14->setObjectName(QStringLiteral("label_14"));
        label_14->setGeometry(QRect(650, 530, 121, 25));
        le_video_path_ = new QLineEdit(tab_control_dev);
        le_video_path_->setObjectName(QStringLiteral("le_video_path_"));
        le_video_path_->setGeometry(QRect(650, 560, 411, 31));
        pb_start_record_ = new QPushButton(tab_control_dev);
        pb_start_record_->setObjectName(QStringLiteral("pb_start_record_"));
        pb_start_record_->setGeometry(QRect(650, 610, 91, 46));
        pb_stop_record_ = new QPushButton(tab_control_dev);
        pb_stop_record_->setObjectName(QStringLiteral("pb_stop_record_"));
        pb_stop_record_->setGeometry(QRect(770, 610, 91, 46));
